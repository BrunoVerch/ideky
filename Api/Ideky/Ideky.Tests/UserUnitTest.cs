...
namespace Ideky.Tests
{
    ...
    public class UserUnitTest
    {
        ...
        {
            var user = new User(70, "João", "picture", 100, 3, DateTime.Now);
            Assert.IsTrue(user.Validate());
            Assert.IsTrue(user.FacebookId == 70);
            Assert.IsTrue(user.Name == "João");
            Assert.IsTrue(user.Picture == "picture");
        ...
        {
            var user = new User(70, "João", "picture", -100, 30, DateTime.Now);
            Assert.IsFalse(user.Validate());
            Assert.IsTrue(user.Messages.Count > 0);
            Assert.IsTrue(user.FacebookId == 70);
            Assert.IsTrue(user.Name == "João");
        ...
        {
            var user = new User(70, "João", "picture", 100, 3, DateTime.Now.AddDays(-10));
            user.SetNewLogin();
            Assert.IsTrue(user.Validate());
            Assert.IsFalse(user.Messages.Count > 0);
            Assert.IsTrue(user.FacebookId == 70);
